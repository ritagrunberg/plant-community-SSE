...
follow up anovas for biomass data to assess which groups contribute to variation in biomass
...
AUDPS calculated across parasite species; did loop so i could check values along the way  
